...
namespace LogTile
{
	internal class Commands
	{
		...
		public void addHook()
		{
			...
			TShockAPI.Commands.ChatCommands.Add(new Command("logtile", Lookup, "lookup"));
			TShockAPI.Commands.ChatCommands.Add(new Command("logtile", Rollback, "rollback"));
			TShockAPI.Commands.ChatCommands.Add(new Command("logtile", SaveQueue, "savequeue"));
			TShockAPI.Commands.ChatCommands.Add(new Command("logtile", Help, "lt"));
      AddPermission( "logtile", "newadmin" );
		}
